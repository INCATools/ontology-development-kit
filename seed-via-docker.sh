...
docker run -e ODK_USER_ID=$(id -u) -e ODK_GROUP_ID=$(id -g) -v $PWD:/work -w /work --rm obolibrary/$ODK_IMAGE:$ODK_TAG odk seed --gitname "$ODK_GITNAME" --gitemail "$ODK_GITEMAIL" "$@"
