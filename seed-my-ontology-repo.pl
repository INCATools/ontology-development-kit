...
if ($prep_initial_release) {
    ...
    runcmd("git add src/ontology/imports/*.owl src/ontology/imports/*.obo") if @depends;
    runcmd("git add src/ontology/subsets/*.owl src/ontology/subsets/*.obo") if -d "src/ontology/subsets";
    runcmd("git add $ontid.owl $ontid.obo");
    runcmd("git add imports/*.owl imports/*.obo") if @depends;
    runcmd("git add subsets/*.owl subsets/*.obo") if -d "src/ontology/subsets";
